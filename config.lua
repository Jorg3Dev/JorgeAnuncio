...
Config.Blips = {
    ...
    Escala = 0.8,
    -- ¿Ocultar completamente los blips de negocios que están cerrados? (true = Ocultar, false = Mostrar en rojo/gris)
    HideWhenClosed = true
}
...
-- Sistema de Logs (Discord Webhooks)
Config.Logs = {
    -- Pon aquí la URL de tu webhook de Discord. Si lo dejas vacío ("", no enviará logs)
    ...
    -- Nombre que tendrá el bot al enviar el mensaje
    BotName = "Negocios GTA Logs",
    
    -- Imagen de perfil del bot (URL)
    BotAvatar = "https://i.imgur.com/8Qj874M.png",
    
    -- Colores en formato Decimal para cada tipo de log
    Colors = {
